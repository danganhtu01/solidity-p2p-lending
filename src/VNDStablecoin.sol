...
/// @notice This is the protocol's **loan asset**: lenders supply VNDD, borrowers post ETH collateral
///         and borrow VNDD. 1 VNDD is intended to represent 1 VND.
...
///      can grab test VNDD. Uses 18 decimals (like ETH) so the protocol's 1e18 / RAY math stays
///      uniform; 1 VNDD = 1e18 base units = 1 VND.
contract VNDStablecoin is ERC20, Ownable {
    ...
    /// @notice Open testnet faucet — anyone can mint themselves FAUCET_AMOUNT VNDD to try the dApp.
